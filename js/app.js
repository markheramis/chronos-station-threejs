...
function init() {
    ...
    var sphereMaterial = createSolarMaterial();
    ...
    var cloudMaterial = createSolarCloudMaterial();
...
function createSolarMaterial() {
    // 4096 is the maximum width for maps
    var earthTexture = THREE.ImageUtils.loadTexture("assets/textures/solar-surface.jpg");
...
function createSolarCloudMaterial() {
